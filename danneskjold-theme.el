...
(let ((c '((class color) (min-colors 89)))
  ...
  (let* ((search-bg      green)
    ...
    (custom-theme-set-faces
     ...
     ;; Org-mode
     `(org-tag                      ((t (:foreground ,yellow :bold nil))))
     `(org-ellipsis                 ((t (:inherit hs-face :underline nil))))
     `(org-link                     ((t (:foreground ,frost :underline ,diredcl))))
     `(org-hide                     ((t (:foreground ,background))))
     `(org-table                    ((t (:foreground ,yellow))))
     `(org-quote                    ((t (:slant italic :foreground ,grey :background ,current-line))))
     `(org-document-info            ((t (:foreground ,orange))))
     `(org-document-info-keyword    ((t (:foreground ,grey-1))))
     `(org-meta-line                ((t (:foreground ,vsubtle))))
     `(org-block-begin-line         ((t (:foreground ,vsubtle))))
     `(org-block-end-line           ((t (:inherit org-block-begin-line))))
     `(org-block-background         ((t (:background ,current-line))))
     `(org-archived                 ((t (:foreground ,grey-.5))))
     `(org-document-title           ((t (:foreground ,twitter))))
     `(org-level-1                  ((t (:foreground ,santa))))
     ...
     `(org-column-title             ((t (:background ,background :foreground ,comment))))
     `(org-verbatim                 ((t (:foreground ,diredcl))))
     `(org-formula                  ((t (:foreground ,orange))))
     `(org-list-dt                  ((t (:foreground ,twitter))))
     `(org-footnote                 ((t (:foreground ,orange))))

     `(org-date                     ((t (:foreground ,violet))))
     `(org-todo                     ((t (:foreground ,yellow))))
     `(org-done                     ((t (:foreground ,green))))
     `(org-headline-done            ((t (:foreground ,grey-.5 :strike-through t :bold nil))))
     `(org-special-keyword          ((t (:foreground ,orange))))
     `(org-checkbox-statistics-todo ((t (:inherit org-todo))))
     `(org-checkbox-statistics-done ((t (:inherit org-done))))

     `(org-habit-clear-face ((t (:background ,background :foreground ,frost :underline t))))
     `(org-habit-clear-future-face ((t (:background ,background :underline t :foreground ,frost))))
     `(org-habit-ready-face ((t (:background ,background :foreground ,green :underline t))))
     `(org-habit-ready-future-face ((t (:background ,background :underline t :foreground ,green))))

     `(org-habit-alert-face ((t (:background ,background :underline t :foreground ,yellow))))
     `(org-habit-alert-future-face ((t (:background ,background :underline t :foreground ,yellow))))
     `(org-habit-overdue-face ((t (:background ,background :underline t :foreground ,red))))
     `(org-habit-overdue-future-face ((t (:background ,background :underline t :foreground ,red))))
     ...
     `(org-agenda-date-today ((t (:foreground ,red))))
     `(org-agenda-structure ((t (:foreground ,violet))))
     `(org-upcoming-deadline ((t (:foreground ,violet))))

     `(secondary-selection ((t (:background ,sbt-midnight))))
     ...
     ;; Wgrep
     `(wgrep-face                  ((t (:foreground ,saffron))))
     `(wgrep-done-face                  ((t (:foreground ,green))))
     `(wgrep-reject-face                  ((t (:foreground ,santa))))
   ...
   ;;; dired+
     ...
     `(ido-first-match ((t (:bold t :foreground ,fg))))
